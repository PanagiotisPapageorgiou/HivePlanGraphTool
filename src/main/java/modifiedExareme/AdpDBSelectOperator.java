...
public class AdpDBSelectOperator implements Serializable {
    ...
    public void print(){
        System.out.println("---------Printing AdpDBSelectOperator-----------");
        System.out.println("Accessing Select query first...");
        if(query != null){
            query.print();
        }
        else{
            System.out.println("Select Query is NULL!");
        }
        ...
        System.out.println("totalInputs: "+totalInputs);
        if(inputs != null){
            for(Map.Entry<String, HashMap<Integer, Integer>> entry : inputs.entrySet()){
                if(entry.getKey() != null){
                    System.out.println("\tTableName: "+entry.getKey());
                    if(entry.getValue() != null){
                        HashMap<Integer, Integer> valueMap = entry.getValue();
                        for(Map.Entry<Integer, Integer> entry2 : valueMap.entrySet()){
                            if(entry2.getKey() != null){
                                System.out.println("\t\t\tPart: "+entry2.getKey() + " - Count: "+entry2.getValue());
                            }
                            else{
                                System.out.println("\t\t\tentry2.getKey() is null!");
                            }
                        }
                    }
                    else{
                    ...
                    System.out.println("inputs entry.getKey() is null!");
                }
            }
        }
        else{
        ...
        System.out.println("totalOutputs: "+totalOutputs);
        if(outputs != null){
            for(Map.Entry<String, HashMap<Integer, Integer>> entry : outputs.entrySet()){
                if(entry.getKey() != null){
                    System.out.println("\tTableName: "+entry.getKey());
                    if(entry.getValue() != null){
                        HashMap<Integer, Integer> valueMap = entry.getValue();
                    ...
                    System.out.println("outputs entry.getKey() is null!");
                }
            }
        }
        else{
