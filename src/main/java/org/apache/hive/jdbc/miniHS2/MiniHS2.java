...
public class MiniHS2 extends AbstractHiveService {
  ...
  private int numberDataNodes;
  private int numberTaskTrackers;
  ...
  private MiniHS2(HiveConf hiveConf, boolean useMiniMR, boolean useMiniKdc,
      String serverPrincipal, String serverKeytab, boolean isMetastoreRemote, int numDataNodes, int numTaskTrackers) throws Exception {
  ...
  public MiniHS2(HiveConf hiveConf, boolean useMiniMR, int numDataNodes, int numTaskTrackers) throws Exception {
    this(hiveConf, useMiniMR, false, null, null, false, numDataNodes, numTaskTrackers);
  }
